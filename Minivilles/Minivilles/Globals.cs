...
namespace Minivilles
{
    ...
    public static class Globals
    {
        ...
        public static Dictionary<CARD_ID, Card> CardInfo = new Dictionary<CARD_ID, Card>()
        {
            ...
            { CARD_ID.BOULANGERIE, new Card(1,COULEUR.VERT,"Boulangerie","Recevez 2 pièce",new List<int>(){2},CARD_ID.BOULANGERIE)},
            { CARD_ID.CAFE, new Card(2,COULEUR.ROUGE,"Café","Recevez 1 pièce du joueur qui a lancé le dé",new List<int>(){3},CARD_ID.CAFE)},
            { CARD_ID.SUPERETTE, new Card(2,COULEUR.VERT,"Superette","Recevez 3 pièce",new List<int>(){4},CARD_ID.SUPERETTE)},
